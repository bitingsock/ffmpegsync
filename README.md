...
ffmpegSync trys to read from a config file (named sync.config) in the directory from which it is run. If it is run with command line arguments (i.e. "ffmpegsync -arg=value") they will overwrite any relevant option.
